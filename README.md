...
One key takeaway from this analysis is that the results after making the changes to Thomas High School's ninth graders were very minor. This signifies that the results are still accurately capturing the overall analysis of the district schools standardized tests scores. The school board and superintendent can now use this analysis to make decisions on the school district regarding funding and priorities.
